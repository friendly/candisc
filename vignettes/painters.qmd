...
A dataset with these features is now available as `candisc::painters2`.

### This vignette

This vignette demonstrates the use of multivariate visualization methods of the `candisc` package, and its' mother package, [`heplots`](https://friendly.github.io/heplots/).
