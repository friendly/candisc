...
The 54 painters are classified into eight schools: Renaissance (A), Mannerist (B), Sciento (C), Venetian (D), Lombard (E), Sixteenth Century (F), Seventeenth Century (G), and French (H). This data was first analysed by @Davenport1972. Jolliffe [-@Jolliffe1986] 
