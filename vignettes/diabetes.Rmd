...
As an aside, we note that the differences among the groups can be readily seen in 3D using `scatter3d` in the `rgl` package.
```{r scatter3d, eval=FALSE}
scatter3d(sspg ~ glutest + instest | group, data=Diabetes, 
          surface=FALSE,	sphere.size=1.5, ellipsoid=TRUE,
          surface.col=c("blue", "darkgreen", "red"))
```
